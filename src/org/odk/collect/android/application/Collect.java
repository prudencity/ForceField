...
public class Collect extends Application {
	...
	public static final String TMPFILE_PATH = CACHE_PATH + File.separator
			+ "tmp.jpg";
	public static final String TMPDRAWFILE_PATH = CACHE_PATH + File.separator
			+ "tmpDraw.jpg";
	public static final String TMPXML_PATH = CACHE_PATH + File.separator
			+ "tmp.xml";
	...
	public static int getQuestionFontsize() {
		...
		String question_font = settings.getString(
				PreferencesActivity.KEY_FONT_SIZE, Collect.DEFAULT_FONTSIZE);
	...
	public static void createODKDirs() throws RuntimeException {
		...
		if (!cardstatus.equals(Environment.MEDIA_MOUNTED)) {
			throw new RuntimeException(Collect.getInstance().getString(
					R.string.sdcard_unmounted, cardstatus));
		}

		String[] dirs = { ODK_ROOT, FORMS_PATH, INSTANCES_PATH, CACHE_PATH,
				METADATA_PATH };
	...
	/**
	 * Predicate that tests whether a directory path might refer to an ODK
	 * Tables instance data directory (e.g., for media attachments).
	 *
	 * @param directory
	 * @return
	 */
	public static boolean isODKTablesInstanceDataDirectory(File directory) {
		/**
		 * Special check to prevent deletion of files that could be in use by
		 * ODK Tables.
		 */
	...
	/**
	 * Construct and return a session context with shared cookieStore and
	 * credsProvider so a user does not have to re-enter login information.
	 *
	 * @return
	 */
